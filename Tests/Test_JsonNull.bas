Attribute VB_Name = "Test_JsonNull"
'@IgnoreModule
Option Explicit
...
Private Sub Instanciation_Success()
    ...
    'Arrange:
        ...
        Set Stream = Service.CreateStringStream("null")
        
        Dim Json As JsonNull
        Set Json = Service.CreateJsonNull(Stream)
    'Act:
...
Private Sub DataType()
    ...
    'Act:
        Const Expected As Long = JsonDataTypeNull
